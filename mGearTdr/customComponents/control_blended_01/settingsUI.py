...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        # New blended array
        self.orientRefArray_groupBox = QtWidgets.QGroupBox(Form)
        self.orientRefArray_groupBox.setObjectName("orientRefArray_groupBox")
        self.gridLayout_5 = QtWidgets.QGridLayout(self.orientRefArray_groupBox)
        self.gridLayout_5.setObjectName("gridLayout_5")
        self.orientRefArray_horizontalLayout = QtWidgets.QHBoxLayout()
        self.orientRefArray_horizontalLayout.setObjectName("orientRefArray_horizontalLayout")
        self.orientRefArray_verticalLayout_1 = QtWidgets.QVBoxLayout()
        self.orientRefArray_verticalLayout_1.setObjectName("orientRefArray_verticalLayout_1")
        self.orientRefArray_listWidget = QtWidgets.QListWidget(self.orientRefArray_groupBox)
        self.orientRefArray_listWidget.setDragDropOverwriteMode(True)
        self.orientRefArray_listWidget.setDragDropMode(QtWidgets.QAbstractItemView.InternalMove)
        self.orientRefArray_listWidget.setDefaultDropAction(QtCore.Qt.MoveAction)
        self.orientRefArray_listWidget.setAlternatingRowColors(True)
        self.orientRefArray_listWidget.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
        self.orientRefArray_listWidget.setSelectionRectVisible(False)
        self.orientRefArray_listWidget.setObjectName("orientRefArray_listWidget")
        self.orientRefArray_verticalLayout_1.addWidget(self.orientRefArray_listWidget)
        self.orientRefArray_horizontalLayout.addLayout(self.orientRefArray_verticalLayout_1)
        self.orientRefArray_verticalLayout_2 = QtWidgets.QVBoxLayout()
        self.orientRefArray_verticalLayout_2.setObjectName("orientRefArray_verticalLayout_2")
        self.orientRefArrayAdd_pushButton = QtWidgets.QPushButton(self.orientRefArray_groupBox)
        self.orientRefArrayAdd_pushButton.setObjectName("orientRefArrayAdd_pushButton")
        self.orientRefArray_verticalLayout_2.addWidget(self.orientRefArrayAdd_pushButton)
        self.orientRefArrayRemove_pushButton = QtWidgets.QPushButton(self.orientRefArray_groupBox)
        self.orientRefArrayRemove_pushButton.setObjectName("orientRefArrayRemove_pushButton")
        self.orientRefArray_verticalLayout_2.addWidget(self.orientRefArrayRemove_pushButton)
        spacerItem2 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.orientRefArray_verticalLayout_2.addItem(spacerItem2)
        self.orientRefArray_horizontalLayout.addLayout(self.orientRefArray_verticalLayout_2)
        self.gridLayout_5.addLayout(self.orientRefArray_horizontalLayout, 0, 0, 1, 1)
        self.gridLayout.addWidget(self.orientRefArray_groupBox, 3, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.orientRefArray_groupBox.setTitle(gqt.fakeTranslate("Form", "Orient Reference Array", None, -1))
        ...
        self.orientRefArrayAdd_pushButton.setText(gqt.fakeTranslate("Form", "<<", None, -1))
        self.orientRefArrayRemove_pushButton.setText(gqt.fakeTranslate("Form", ">>", None, -1))
