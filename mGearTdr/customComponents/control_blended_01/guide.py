...
EMAIL = "geerem@hotmail.com, hello@miquel-campos.com, dunc@3drstudio.co.uk"
VERSION = [0, 0, 1]
TYPE = "control_blended_01"
NAME = "controlBlended"
DESCRIPTION = "Simple controler with blended orientation and translation between 2 inputs and Rot order selection. \n"\
...
class Guide(guide.ComponentGuide):
    ...
    connectors = ["blended_ori", "blended_trans", "blended_trans_and_ori"]
    ...
    def addParameters(self):
        ...
        self.pTranslateRefArray = self.addParam("orientrefarray", "string", "")
...
class componentSettings(MayaQWidgetDockableMixin, guide.componentMainSettings):
    ...
    def populate_componentControls(self):
        ...
        orientRefArrayItems = self.root.attr("orientrefarray").get().split(",")
        for item in orientRefArrayItems:
            self.settingsTab.orientRefArray_listWidget.addItem(item)
    ...
    def create_componentConnections(self):
        ...
        self.settingsTab.orientRefArrayAdd_pushButton.clicked.connect(
            partial(self.addItem2listWidget,
                    self.settingsTab.orientRefArray_listWidget,
                    "orientrefarray"))
        self.settingsTab.orientRefArrayRemove_pushButton.clicked.connect(
            partial(self.removeSelectedFromListWidget,
                    self.settingsTab.orientRefArray_listWidget,
                    "orientrefarray"))
        self.settingsTab.orientRefArray_listWidget.installEventFilter(self)
    ...
    def eventFilter(self, sender, event):
        if event.type() == QtCore.QEvent.ChildRemoved:
            ...
            elif sender == self.settingsTab.orientRefArray_listWidget:
                self.updateListAttr(sender, "orientrefarray")
            return True
        else:
