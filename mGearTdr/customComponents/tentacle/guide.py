...
# guide info
AUTHOR = "Duncan Rudd"
URL = "www.3drstudio.co.uk"
EMAIL = "dunc@3drstudio.co.uk"
VERSION = [0, 0, 1]
TYPE = "tentacle"
NAME = "tentacle"
DESCRIPTION = "IK spline driven tentacle with FK offsets"
...
class Guide(guide.ComponentGuide):
    ...
    def addParameters(self):
        ...
        self.pNumCtls = self.addParam("num_fk_ctls", "long", 3, 0, None)
        self.pNumJoints = self.addParam("num_joints", "long", 3, 0, None)
...
class componentSettings(MayaQWidgetDockableMixin, guide.componentMainSettings):
    ...
    def populate_componentControls(self):
        ...
        self.settingsTab.fkCtls_spinBox.setValue(self.root.attr("num_fk_ctls").get())
        self.settingsTab.joints_spinBox.setValue(self.root.attr("num_joints").get())
    ...
    def create_componentConnections(self):
        ...
        self.settingsTab.fkCtls_spinBox.valueChanged.connect(
            partial(self.updateSpinBox, self.settingsTab.fkCtls_spinBox, "num_fk_ctls"))

        self.settingsTab.joints_spinBox.valueChanged.connect(
            partial(self.updateSpinBox, self.settingsTab.joints_spinBox, "num_joints"))
